...
public class StringSet {
    ...
    public static TreeSet<String> findUniqueWords(){
        String test="Carroll began writing the manuscript of the story the next day, although that earliest version is lost. "
        ...
        String[] kelimeler =test.toLowerCase(Locale.ROOT).replaceAll("[^a-zA-Z\\s]","").split("\\s+");
        TreeSet<String> unique = new TreeSet<>(Arrays.asList(kelimeler));
